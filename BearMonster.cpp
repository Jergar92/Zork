...
Bear::Bear(const char* name, const char* description, int life, int atack, int armor, Room* location) :Creature(name, description, life, atack, armor, location)
{
...
void Bear::Attack(Player* hero){//atack player
...
void Bear::Attack(Creature* monster){//atack npc
...
void Bear::Die(){//if the creature die drop all objects
